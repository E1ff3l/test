	...
	$( "#choix-livraison" ).click( function() {
		if ( $( "#special_k" ).val() == '' ) window.location.href = $( "#url_livraison" ).val();
		else forcer_mb( $( "#special_k" ).val(), '', $( "#url_livraison" ).val() );
	});
	$( "#choix-emporter" ).click( function() {
		if ( $( "#special_k" ).val() == '' ) window.location.href = $( "#url_ae" ).val();
		else forcer_mb( $( "#special_k" ).val(), '', $( "#url_ae" ).val() );
	});
	// ------------------------------------------------------------------------ //
	...
	$('.changer-categorie ul').hideMaxListItems({
		'max':4, 
		'speed':500, 
		'moreHTML':'<p class="maxlist-more"><a href="#" title="Tout voir">xxx...</a></p>',
		moreText:'...',
		lessText:'cacher la liste',
	});

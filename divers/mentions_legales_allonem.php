...
<html xmlns="https://www.w3.org/1999/xhtml">
	<head>
		...
		<title>ALLO NEM France - Les mentions légales</title>
		<meta name="description" content="Les mentions légales de Allo Nem France" />
			...
			<div id="page">
				...
				<div id="content" class="inner">
					<div id="col-unique-contenu">
						<h1>ALLO NEM - Les mentions légales</h1>
						<br />
				    ...
				    <fieldset>
					   ...
					   <div id="div-connexion">
						  ...
						  Ce site est la propriété de ALLO NEM FRANCE<br /><br />
						  Société en cours de formation<br /><br />
<!--
						  Siège social :<br />
						  <b>Restomalin</b><br />
...
<!--						  Directeur de la publication : Olivier FREYMANN<br /><br />-->
						  ...
						  Adresse email de contact : contact@allo-nem.fr<br />
						  <!--Numéro de téléphone : 0805 69 69 67 (appels gratuits depuis un poste fixe)-->
						  </p>
						  
						  
						  <p class="maxlist-more"><a href="./contacter_allonem.php?lb=1" class="go_up iframe_mon_compte">Nous contacter par formulaire</a></p>

...
<html xmlns="https://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Allo Nem France - Plan du site</title>
		<meta name="description" content="Plan du site Allo-nem.fr" />
		<meta name="robots" content="index,follow" />
		
		<link rel="icon" type="image/gif" href="/img/favicon-RM.gif" >
		
		<?
		// Affichage des CSS pour le site classique + MB
		if ( !$_SESSION[ "franchise" ][ "is_franchise" ] ) {
			echo "		<link rel='stylesheet' type='text/css' href='/css/style.css" . $cache . "'>\n";
			echo "		<link rel='stylesheet' type='text/css' href='/css/anythingslider.css" . $cache . "'>\n";
		}
		
		// En cas de franchise, on utilise la CSS adaptée
		else {
			echo "		<link rel='stylesheet' type='text/css' href='/css/style_" . $_SESSION[ "franchise" ][ "nom_franchise" ] . ".css" . $cache . "'>\n";
			echo "		<link rel='stylesheet' type='text/css' href='/css/anythingslider_" . $_SESSION[ "franchise" ][ "nom_franchise" ] . ".css" . $cache . "'>\n";
		}
		?>
			...
			<div id="page">
				...
				<div id="sitemap" class="inner">
					<div id="col-unique-contenu">
						<p class="h1">ALLO NEM FRANCE - Plan du site</p>
						<br /><br />
						
						<h1>Pour bien commander vos repas à livrer</h1>
						...
						<p style="text-align:justify;">
							Nos points de ventes assurent la livraison de repas à votre domicile ou au bureau.<br />

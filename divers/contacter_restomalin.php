...
<html lang="fr">
	<head>
		...
		<title>Restomalin - Contactez-nous</title>
	...
	?>
			...
			<form id="formulaire" method="post" action="./formulaire-fin-contacter-restomalin.html">
				...
				<fieldset>
					...
					<div id="div-connexion">
						<p class="legende">
							Toute question ou remarque mérite une réponse. L'Equipe Restomalin s'engage à vous répondre dans les meilleurs délais (laissez-nous une adresse mail valide).
						</p>
						<br />
						<p>
						 <img src="../img/urgences_vers_besoin_aide.gif" width="800" height="21">
						</p>
						<br />
						<div class="field">
